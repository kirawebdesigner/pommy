(function () {
  ...
  function renderHome() {
    ...
    var categories = [
      ["Burger", "burger", "Beef, cheese, fasting and chicken burger choices.", "category-main.svg"],
      ["Pizza", "pizza", "Pommy specials, chicken, tuna, vegetable and more.", "category-desserts.svg"],
      ["Chicken", "chicken", "Grilled, crispy, wings, rice dishes and roast chicken.", "category-breakfast.svg"],
      ["Wrap", "wrap", "Chicken, tuna and vegetable wraps with fries available.", "category-drinks.svg"]
    ];
    var trust = [
