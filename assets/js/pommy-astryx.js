import { _ as e, a as t, b as n, c as r, d as i, f as a, g as o, h as s, i as c, l, m as u, n as d, o as f, p, r as m, s as h, t as g, u as _, v, y } from "../useTooltip-Bfg706nn.mjs";
...
var b = /* @__PURE__ */ y(((e) => {
	...
	function x(e) {
		if (h = !1, b(e), !m) if (n(c) !== null) m = !0, S || (S = !0, C());
		else {
			var t = n(l);
	...
	}), In = Dn(Fn), Ln = Dn(f({}, Fn, { dataTransfer: 0 })), Rn = Dn(f({}, An, { relatedTarget: 0 })), zn = Dn(f({}, On, {
		animationName: 0,
		elapsedTime: 0,
		pseudoElement: 0
	})), Bn = Dn(f({}, On, { clipboardData: function(e) {
		return "clipboardData" in e ? e.clipboardData : window.clipboardData;
	} })), Vn = Dn(f({}, On, { data: 0 })), Hn = {
		Esc: "Escape",
		Spacebar: " ",
		Left: "ArrowLeft",
		Up: "ArrowUp",
	...
	function bi(e, t, n, r, a, o) {
		...
		if (r = e, typeof e == "function") _i(e) && (s = 1);
			...
			case g: return xi(n.children, a, o, t);
			case _:
				s = 8, a |= 24;
				break;
			case y: return e = gi(12, n, t, a | 2), e.elementType = y, e.lanes = o, e;
	...
	function Ua(e) {
		...
		function l(e, t, n, r) {
			var i = n.type;
			return i === g ? d(e, t, n.props.children, r, n.key) : t !== null && (t.elementType === i || typeof i == "object" && i && i.$$typeof === C && Pa(i) === t.type) ? (t = a(t, n.props), Va(t, n), t.return = e, t) : (t = bi(n.type, n.key, n.props, null, e.mode, r), Va(t, n), t.return = e, t);
		}
		function u(e, t, n, r) {
		...
		function f(e, t, n) {
			...
			if (typeof t == "object" && t) {
				switch (t.$$typeof) {
					case m: return n = bi(t.type, t.key, t.props, null, e.mode, n), Va(n, t), n.return = e, n;
					case h: return t = wi(t, e.mode, n), t.return = e, t;
				...
				switch (o.$$typeof) {
					case m:
						a: {
							...
							o.type === g ? (c = xi(o.props.children, e.mode, c, o.key), c.return = e, e = c) : (c = bi(o.type, o.key, o.props, null, e.mode, c), Va(c, o), c.return = e, e = c);
						}
						return s(e);
					case h:
						a: {
	...
	function Fc(e, t, n) {
		...
		switch (t.lanes = 0, t.tag) {
			...
			case 3:
				...
				return t;
			case 26: return _c(e, t), e === null ? (n = kf(t.type, null, t.pendingProps, null)) ? t.memoizedState = n : M || (n = t.type, e = t.pendingProps, r = Bd(ve.current).createElement(n), r[ht] = t, r[gt] = e, Pd(r, n, e), A(r), t.stateNode = r) : t.memoizedState = kf(t.type, e.memoizedProps, t.pendingProps, e.memoizedState), null;
	...
	function zc(e, t) {
		t !== null && (e.flags |= 4), e.flags & 16384 && (t = e.tag === 22 ? 536870912 : k(), e.lanes |= t, Xl |= t);
	}
	function Bc(e, t) {
	...
	function Vc(e, t, n) {
		...
		switch (zi(t), t.tag) {
			...
			case 27:
				if (O(t), n = ve.current, a = t.type, e !== null && t.stateNode != null) e.memoizedProps !== r && Ic(t);
				else {
					if (!r) {
				...
				return V(t), null;
			case 5:
				if (O(t), a = t.type, e !== null && t.stateNode != null) e.memoizedProps !== r && Ic(t);
				else {
					if (!r) {
						if (t.stateNode === null) throw Error(i(166));
						return V(t), null;
			...
			case 19:
				...
				return r.tail === null ? (V(t), null) : (e = r.tail, r.rendering = e, r.tail = e.sibling, r.renderingStartTime = Fe(), e.sibling = null, n = P.current, D(P, a ? n & 1 | 2 : n & 1), M && Ii(t, r.treeForkCount), e);
			case 22:
	...
	function Lu(e, t, n, r, a, o, s, c, l) {
		...
		if (t !== null) {
			...
			if (o = t.lanes | t.childLanes, o |= si, ot(e, n, o, s, c, l), e === G && (K = G = null, q = 0), ou = t, au = e, su = n, cu = o, lu = a, uu = r, t.subtreeFlags & 10256 || t.flags & 10256 ? (e.callbackNode = null, e.callbackPriority = 0, Xu(ze, function() {
				return Uu(), null;
	...
	function Bu() {
		if (X === 4 || X === 3) {
			...
			if (i === 0 && (iu = null), dt(n), t = t.stateNode, Ge && typeof Ge.onCommitFiberRoot == "function") try {
	...
	function qu(e, t) {
		t === 0 && (t = k()), e = di(e, t), e !== null && (at(e, t), rd(e));
	}
	function Ju(e) {
...
}, ie = (e, t, n) => Math.max(t, Math.min(n, e));
function C(e) {
	return e.split("").map((e) => e + e).join("");
}
function ae(e) {
	if (typeof e != "string") return null;
	let t = e.trim().replace(/^#/, ""), n = t.length === 3 || t.length === 4 ? C(t) : t;
...
function oe(e) {
	...
	let r = (e) => ie(e.endsWith("%") ? parseFloat(e) / 100 * 255 : parseFloat(e), 0, 255), i = r(n[0]), a = r(n[1]), o = r(n[2]);
	if ([
		i,
		a,
		o
...
function se(e) {
	let t = e.trim(), n = re[t.toLowerCase()];
	return n ? { ...n } : t.startsWith("#") ? ae(t) : /^rgba?\(/i.test(t) ? oe(t) : null;
}
function ce(e, t, n) {
	let r = (e) => ie(Math.round(e), 0, 255).toString(16).padStart(2, "0").toUpperCase();
	return `#${r(e)}${r(t)}${r(n)}`;
}
function le({ r: e, g: t, b: n, a: r }) {
	if (r >= 1) return ce(e, t, n);
	let i = (e) => ie(Math.round(e), 0, 255);
	return `rgba(${i(e)}, ${i(t)}, ${i(n)}, ${parseFloat(r.toFixed(4))})`;
}
//#endregion
...
Object.fromEntries(Object.keys(T).map((e) => [e, fe(e)]));
function pe(e) {
	let t = 0, n = null, r = !1;
	for (let i = 0; i < e.length; i++) {
		let a = e[i];
		if (n !== null) {
			r ? r = !1 : a === "\\" ? r = !0 : a === n && (n = null);
			continue;
		}
		if (a === "\"" || a === "'") {
			n = a;
		...
		if (a === "," && t === 0) return [e.slice(0, i).trim(), e.slice(i + 1).trim()];
	}
	return null;
}
function me(e) {
	let t = e.trim();
	return !t.startsWith("light-dark(") || !t.endsWith(")") ? null : pe(t.slice(11, -1));
}
function he(e, t) {
	if (Array.isArray(e)) return t === "dark" ? e[1] : e[0];
	let n = me(e);
	return n === null ? e : t === "dark" ? n[1] : n[0];
}
function E(e, t) {
	let n = 0;
...
function D(e) {
	let t = e.trim(), n = t.match(/\s+([\d.]+)%$/);
	return n ? {
		color: t.slice(0, n.index).trim(),
		percentage: parseFloat(n[1])
	} : {
		color: t,
		percentage: null
	};
...
function ge(e) {
	let t = e.match(/^in\s+([\w-]+)\s*,\s*(.+)$/s);
	if (!t) return null;
	let [, n, r] = t;
	if (n.toLowerCase() !== "srgb") return null;
	let i = pe(r);
	if (i === null) return null;
	let a = D(i[0]), o = D(i[1]);
	if (a === null || o === null) return null;
	let s = se(a.color), c = se(o.color);
	if (s === null || c === null) return null;
	let l, u;
	a.percentage !== null && o.percentage !== null ? (l = a.percentage, u = o.percentage) : a.percentage === null ? o.percentage === null ? (l = 50, u = 50) : (u = o.percentage, l = 100 - u) : (l = a.percentage, u = 100 - l);
	let d = l + u;
	if (d <= 0) return null;
	let f = l / d, p = u / d, m = d < 100 ? d / 100 : 1, h = f * s.a + p * c.a, g = (e, t) => f * e * s.a + p * t * c.a, _ = g(s.r, c.r), v = g(s.g, c.g), y = g(s.b, c.b);
	return le({
		...h === 0 ? {
			r: 0,
			g: 0,
...
function _e(e) {
	let t = e.indexOf("color-mix(");
	if (t === -1) return e;
	let n = t + 9, r = E(e, n);
	if (r === -1) return e;
	let i = _e(e.slice(n + 1, r)), a = ge(i) ?? `color-mix(${i})`;
	return e.slice(0, t) + a + _e(e.slice(r + 1));
}
function ve(e, t, n, r) {
	let i = e.indexOf("var(");
	if (i === -1) return e;
	let a = i + 3, o = E(e, a);
	if (o === -1) return e;
	let s = e.slice(a + 1, o), c = pe(s), l = (c ? c[0] : s).trim(), u = c ? c[1] : null, d;
	r.has(l) ? d = e.slice(i, o + 1) : l in t ? (r.add(l), d = be(l, t, n, r), r.delete(l)) : d = u === null ? e.slice(i, o + 1) : ve(u.trim(), t, n, r);
	let f = ve(e.slice(o + 1), t, n, r);
	return e.slice(0, i) + d + f;
}
function ye(e, t, n, r) {
	return !e.includes("var(") && !e.includes("color-mix(") ? e : _e(ve(e, t, n, r));
}
function be(e, t, n, r) {
...
function xe(e) {
	let t = {};
	for (let n of Object.keys(e)) be(n, e, t, /* @__PURE__ */ new Set());
	return t;
}
function Se(e, t) {
	let { mode: n } = t, r = {};
	for (let [e, t] of Object.entries(T)) r[e] = he(t, n);
	if (e == null) return xe(r);
	for (let [t, i] of Object.entries(e.tokens)) r[t] = he(i, n);
	if (e.__inputTokens) for (let [t, i] of Object.entries(e.__inputTokens)) i !== void 0 && (r[t] = he(i, n));
	return xe(r);
}
//#endregion
//#region node_modules/@astryxdesign/core/dist/hooks/useMediaQuery.js
var O = /* @__PURE__ */ n(v(), 1);
function Ce(e, t = !1) {
	return (0, O.useSyncExternalStore)((0, O.useCallback)((t) => {
		let n = window.matchMedia(e);
		return n.addEventListener("change", t), () => n.removeEventListener("change", t);
	}, [e]), (0, O.useCallback)(() => window.matchMedia(e).matches, [e]), (0, O.useCallback)(() => t, [t]));
}
//#endregion
//#region node_modules/@astryxdesign/core/dist/theme/useTheme.js
var we = /*#__PURE__*/ (0, O.createContext)(null);
we.displayName = "ThemeContext";
function Te() {
...
var Oe = /* @__PURE__ */ new Set(), ke = null;
function Ae() {
	for (let e of Oe) e();
}
function je(e) {
	return Oe.add(e), Oe.size === 1 && typeof MutationObserver < "u" && (ke = new MutationObserver(Ae), ke.observe(document.documentElement, {
		attributes: !0,
		attributeFilter: ["data-theme"]
	})), () => {
		Oe.delete(e), Oe.size === 0 && ke && (ke.disconnect(), ke = null);
	};
}
function Me() {
	return () => {};
...
function Ne(e) {
	return (0, O.useSyncExternalStore)(e ? Me : je, e ? De : Te, Ee);
}
function Pe() {
	let e = (0, O.use)(we), t = Ne(e != null), n = Ce("(prefers-color-scheme: dark)"), r = e?.mode ?? t ?? "system", i = e?.theme ?? null, a = r === "system" ? n ? "dark" : "light" : r, o = (0, O.useMemo)(() => Se(i, { mode: a }), [i, a]);
	return {
		name: i?.name ?? "default",
		mode: a,
		token: (e) => o[e] ?? "",
...
var Fe = {
	...
	kTgw9: "x13faqbe",
	$$css: !0
} }, Ye = null, Xe = /* @__PURE__ */ new Map();
function Ze() {
	return Ye ||= new ResizeObserver((e) => {
		for (let t of e) {
			let e = Xe.get(t.target);
			e && e(t);
		}
	}), Ye;
}
function Qe(e, t) {
	Xe.set(e, t), Ze().observe(e), t({ target: e });
}
function $e(e) {
	Xe.delete(e), Ye && (Ye.unobserve(e), Xe.size === 0 && (Ye.disconnect(), Ye = null));
}
//#endregion
//#region node_modules/@astryxdesign/core/dist/Text/useTruncation.js
function et(e) {
	let { maxLines: t } = e, [n, r] = (0, O.useState)(!1), [i, a] = (0, O.useState)(""), o = (0, O.useRef)(null), s = (0, O.useCallback)((e) => {
		if (t === 0) {
			r(!1);
			return;
		}
	...
	return {
		ref: (0, O.useCallback)((e) => {
			o.current && $e(o.current), o.current = e, e && t > 0 ? typeof ResizeObserver < "u" ? Qe(e, () => {
				s(e);
			}) : s(e) : (r(!1), a(""));
		}, [t, s]),
		isTruncated: n,
...
function nt(e, t, n, r) {
	...
	let i = tt(e, typeof t == "string" ? { className: t } : t ?? {});
	return typeof n == "string" ? i = tt(i, { className: n }) : n != null && (i = tt(i, { style: n })), r != null && (i = tt(i, { style: r })), i;
}
//#endregion
...
var k = m(), it = /*#__PURE__*/ (0, O.lazy)(async () => import("../Tooltip-ztFibt0f.mjs").then((e) => ({ default: e.Tooltip }))), at = {
	body: "primary",
	large: "primary",
	label: "primary",
...
function ot(e) {
	return e in Re ? e : "body";
}
function st({ type: t = "body", size: n, color: r, weight: i, display: a = "inline", maxLines: o = 0, hasTruncateTooltip: s = !0, wordBreak: c, textWrap: l, justify: u = "start", hasCapsize: f = !1, hasStrikethrough: p = !1, hasTabularNumbers: m = !1, xstyle: h, className: g, style: _, as: v = "span", children: y, ref: b, ...x }) {
	let S = r ?? at[t] ?? "primary", ee = ot(t), te = c ?? (o === 1 ? "break-all" : "break-word"), ne = o > 0 || f ? "block" : a, re = et({ maxLines: o }), ie = typeof s == "string" ? s : "above", C = o > 0 && s !== !1 && re.isTruncated, ae = (0, O.useRef)(null), oe = o > 1 ? { WebkitLineClamp: o } : void 0;
	return /*#__PURE__*/ (0, k.jsxs)(k.Fragment, { children: [/*#__PURE__*/ (0, k.jsx)(v, {
		ref: rt(b, re.ref, ae),
		...nt(d("text", {
			type: t,
			size: n,
			color: S
		}), e(Fe[S], Re[ee], n && ze[n], Le[ee], i && Ie[i], o === 1 ? Ve.singleLine : o > 1 ? Ve.multiLine : Be[ne], o > 0 && He[te], l && Ue[l], u !== "start" && qe[u], f && We.enabled, p && Ge.strikethrough, m && Ke.enabled, h), g, {
			..._,
			...oe
		}),
		title: C ? re.fullText : void 0,
		...x,
		children: y
	}), C && /*#__PURE__*/ (0, k.jsx)(O.Suspense, {
		fallback: null,
		children: /*#__PURE__*/ (0, k.jsx)(it, {
			anchorRef: ae,
			content: /*#__PURE__*/ (0, k.jsx)("span", {
				...e(Je.content),
				children: re.fullText
			}),
			placement: ie
		})
	})] });
...
function dt({ size: t = "md", shade: n = "default", label: r, xstyle: i, className: a, style: o, "aria-label": s, "data-testid": c, ref: l, ...u }) {
	let f = (0, O.useRef)(null), { tokens: p } = Pe();
	(0, O.useEffect)(() => {
		let e = f.current;
		if (e == null) return;
		let r = e.getContext("2d");
		if (!r) return;
		let { border: i, diameter: a } = lt[t], o = window.devicePixelRatio || 1, s = n === "inherit" ? getComputedStyle(e).color : null, c = n === "inherit" ? s : n === "onMedia" ? p["--color-on-dark"] : n === "subtle" ? p["--color-text-secondary"] : p["--color-accent"], l = n === "inherit" ? s : n === "onMedia" ? `${p["--color-on-dark"]}4D` : p["--color-track"], u = a + i * 2, d = Math.round(u * o), m = d + d % 2, h = m / u, g = a / 2 * h, _ = i * h;
		e.height = e.width = m, e.style.width = e.style.height = u + "px", r.lineCap = "round", r.lineWidth = _;
		let v = m / 2;
		r.beginPath(), r.arc(v, v, g, 0, 2 * Math.PI), r.strokeStyle = l, n === "inherit" && (r.globalAlpha = .3), r.stroke(), r.globalAlpha = 1, r.beginPath(), r.arc(v, v, g, ct * Math.PI, 2.25 % 2 * Math.PI), r.strokeStyle = c, r.stroke();
	}, [
		n,
		t,
		p
	]);
	let { border: m, diameter: h } = lt[t], g = h + m * 2, _ = r != null, v = /*#__PURE__*/ (0, k.jsx)("span", {
		ref: _ ? void 0 : l,
		role: "status",
		"aria-label": s ?? (typeof r == "string" ? r : void 0) ?? "Loading",
		"data-testid": _ ? void 0 : c,
		..._ ? {} : u,
		...nt(_ ? "" : d("spinner", {
			size: t,
			shade: n
		}), e(ut.spinner, !_ && i), _ ? void 0 : a, {
			..._ ? {} : o,
			width: g,
			height: g
		}),
	...
	return _ ? /*#__PURE__*/ (0, k.jsxs)("div", {
		ref: l,
		"data-testid": c,
		...u,
		...nt(d("spinner", {
		...
		children: [v, typeof r == "string" ? /*#__PURE__*/ (0, k.jsx)(st, {
			type: "body",
			weight: "bold",
			children: r
		}) : r]
...
function ft({ children: e, as: t = "span", ref: n, ...r }) {
	return /*#__PURE__*/ (0, O.createElement)(t, {
		ref: n,
		...r,
...
var pt = "data-astryx-edge-comp", mt = /*#__PURE__*/ (0, O.createContext)(null);
mt.displayName = "SizeContext";
function ht(e, t = "md") {
	let n = (0, O.use)(mt);
	return e ?? n ?? t;
}
...
var gt = /*#__PURE__*/ (0, O.createContext)(null);
gt.displayName = "ButtonGroupContext";
function _t() {
	return (0, O.use)(gt);
}
//#endregion
//#region node_modules/@astryxdesign/core/dist/Link/LinkContext.js
var vt = /*#__PURE__*/ (0, O.createContext)(null);
vt.displayName = "LinkContext";
//#endregion
//#region node_modules/@astryxdesign/core/dist/Link/useLinkComponent.js
function yt(e) {
	function t({ href: t, ref: n, ...r }) {
		return /*#__PURE__*/ (0, O.createElement)(e, {
			ref: n,
			href: t,
			to: t,
			...r
	...
	return t.displayName = `LinkWithTo(${typeof e == "string" ? e : e.displayName || e.name || "Component"})`, t;
}
function bt(e) {
	let t = (0, O.use)(vt), n = e ?? t?.component ?? "a";
	return (0, O.useMemo)(() => n === "a" ? "a" : yt(n), [n]);
}
//#endregion
...
var xt = {
	...
	$$css: !0
}, { "--x-width": ((e) => typeof e == "number" ? e + "px" : e ?? void 0)(e) }] }, Ct = {
	sm: {
		kZKoxP: "x6k0iem",
		$$css: !0
	},
...
function A({ label: t, variant: n = "secondary", size: r, type: i = "button", isDisabled: a = !1, isLoading: o = !1, isInterruptible: s = !1, clickAction: c, icon: l, isIconOnly: u = !1, width: f, children: p, endContent: m, tooltip: h, href: _, as: v, target: y, rel: b, xstyle: x, className: S, style: ee, ref: te, ...ne }) {
	let re = ht(r, "md"), ie = _t(), [C, ae] = (0, O.useTransition)(), oe = (0, O.useRef)(!1), se = o || C, ce = C || s, le = ie?.isDisabled ?? !1, ue = a || le || se && !s, de = bt(v), w = _ != null && !ue, T = h != null && ue, fe = g({
		placement: "above",
		isEnabled: h != null
	}), pe = (e) => {
		if (ue || oe.current && !s) {
		...
		ne.onClick?.(e), c && !e.defaultPrevented && (oe.current = !0, ae(async () => {
			try {
				await c(e);
			} finally {
				oe.current = !1;
		...
		e.key === "Enter" || e.key === " " ? e.preventDefault() : ne.onKeyDown?.(e);
	} : void 0, he = n === "ghost" ? { [pt]: "" } : null, E = e(xt.base, Ct[re], Tt[n], u && xt.iconOnly, ue && xt.disabled, T && xt.ariaDisabled, w && xt.link, !ie && xt.pressable, ie && (ie.orientation === "horizontal" ? Dt.horizontal : Dt.vertical), ie && (n === "primary" || n === "destructive") && (ie.orientation === "horizontal" ? Dt.onSolidHorizontal : Dt.onSolidVertical), f != null && St.width(f), x), D = nt(d("button", {
		variant: n,
		size: re
	}), E, S, ee), ge = /*#__PURE__*/ (0, k.jsxs)(k.Fragment, { children: [
		se && /*#__PURE__*/ (0, k.jsx)("span", {
			...{
		...
		/*#__PURE__*/ (0, k.jsxs)("span", {
			...e(xt.contentWrapper, se && (ce ? Et.hiddenContentDelayed : Et.hiddenContent)),
			"aria-hidden": se || void 0,
			children: [
				l && /*#__PURE__*/ (0, k.jsx)("span", {
					...e(xt.iconWrapper, wt[re]),
					children: l
				}),
				u ? null : /*#__PURE__*/ (0, k.jsx)("span", {
					className: "xb3r6kr xlyipyv xeuugli",
					children: p ?? t
				}),
				!u && m && /*#__PURE__*/ (0, k.jsx)("span", {
	...
	] }), _e = u && t !== "" || se && !u || p != null && p !== t ? { "aria-label": t } : null, ve = h == null ? null : { "aria-describedby": [ne["aria-describedby"], fe.describedBy].filter(Boolean).join(" ") || void 0 }, ye = rt(te, h == null ? void 0 : fe.ref), be;
	return be = w ? /*#__PURE__*/ (0, k.jsx)(de, {
		ref: ye,
		href: _,
		target: y,
		rel: b,
		...
		onClick: pe,
		...me ? { onKeyDown: me } : null,
		children: ge
	}), h ? /*#__PURE__*/ (0, k.jsxs)(k.Fragment, { children: [be, fe.renderTooltip(h)] }) : be;
}
A.displayName = "Button";
//#endregion
//#region node_modules/@astryxdesign/core/dist/Badge/Badge.js
var Ot = { base: {
	k1xSpc: "x3nfvp2",
	kGNEyG: "x6s0dn4",
	kjj79g: "xl56j7k",
...
function At({ variant: t = "neutral", label: n, icon: r, xstyle: i, className: a, style: o, ref: s, ...c }) {
	return /*#__PURE__*/ (0, k.jsxs)("span", {
		ref: s,
		...nt(d("badge", { variant: t }), e(Ot.base, kt[t], i), a, o),
		...c,
		children: [r, n]
	});
}
...
//#endregion
//#region src/astryx-islands.css
var jt = ne();
//#endregion
//#region src/astryx-islands.jsx
function Mt() {
	return (window.Pommy?.readCart?.() || []).reduce((e, t) => e + Number(t.quantity || 0), 0);
}
function Nt() {
	let [e, t] = (0, O.useState)(Mt);
	return (0, O.useEffect)(() => {
		let e = () => t(Mt());
		return document.addEventListener("pommy:cart-changed", e), window.addEventListener("storage", e), e(), () => {
			document.removeEventListener("pommy:cart-changed", e), window.removeEventListener("storage", e);
		};
	}, []), /* @__PURE__ */ (0, k.jsx)(A, {
		className: "pommy-astryx-cart-button pommy-cart-open",
		label: `Open cart, ${e} ${e === 1 ? "item" : "items"}`,
		variant: "secondary",
		size: "sm",
		onClick: () => window.Pommy?.openCart?.(),
		endContent: /* @__PURE__ */ (0, k.jsx)(At, {
...
function Pt() {
	document.querySelectorAll("[data-astryx-cart-root]").forEach((e) => {
		e.dataset.astryxMounted !== "true" && (e.dataset.astryxMounted = "true", (0, jt.createRoot)(e).render(/* @__PURE__ */ (0, k.jsx)(Nt, {})));
	});
}
Pt(), window.Pommy?.motionReady?.then(Pt);
//#endregion
